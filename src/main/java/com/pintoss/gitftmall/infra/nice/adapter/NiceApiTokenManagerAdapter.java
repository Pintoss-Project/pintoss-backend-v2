...
import com.pintoss.gitftmall.infra.nice.client.NiceApiClient;
import com.pintoss.gitftmall.infra.nice.config.NiceApiProperties;
...
import com.pintoss.gitftmall.infra.nice.repository.NiceApiTokenRepository;
import com.pintoss.gitftmall.infra.nice.client.request.NiceApiAccessTokenResult;
import com.pintoss.gitftmall.infra.nice.client.request.NiceApiEncryptedTokenRequest;
import com.pintoss.gitftmall.infra.nice.client.request.NiceApiEncryptedTokenRequestDataBody;
import com.pintoss.gitftmall.infra.nice.client.request.NiceApiEncryptedTokenRequestDataHeader;
import com.pintoss.gitftmall.infra.nice.client.response.NiceApiEncryptedTokenResult;
...
public class NiceApiTokenManagerAdapter implements NiceApiTokenManagerPort {
    ...
    public NiceApiTokenManagerAdapter(NiceApiProperties niceApiProperties, NiceApiClient niceApiClient, NiceApiTokenRepository niceApiTokenRepository) {
