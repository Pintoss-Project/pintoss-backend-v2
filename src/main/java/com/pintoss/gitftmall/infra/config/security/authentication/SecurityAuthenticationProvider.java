package com.pintoss.gitftmall.infra.config.security.authentication;
...
@Component
public class SecurityAuthenticationProvider implements SecurityAuthenticationProviderPort {

    private final IUserRepository userRepository;

    @Autowired
    public SecurityAuthenticationProvider(IUserRepository userRepository) {
